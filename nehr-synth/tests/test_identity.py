...
@pytest.mark.parametrize(("value", "expected"), [
    ("a", "3"), ("123456", "6"), ("ab32kcdak3", "9"),
    ("chaseisreallycoolyay", "7"), ("1", "8"), ("moose", "7"),
    ("MOOSE", "7"), ("MooSE", "7"), ("adD3Eddf429daD999", "1"),
])
...
@pytest.mark.parametrize("changes", [
    {"patients": 0}, {"patients": True}, {"patients": 1_000_001},
    {"phn_issued": 999_999}, {"nic": False, "phn": False, "passport": False},
    {"age_min": 12}, {"nic_mode": "realistic"}, {"passport_width": 1},
    {"phn_prefix": "!!!!"}, {"reference_date": "2026-02-29"},
])
...
def test_duplicate_and_missing_identifiers():
    ...
    assert any("Duplicate patient" in i["message"] for i in application_checks(resources, config, assignments))
    resources[0]["identifier"] = []
    assert any("At least one" in i["message"] for i in application_checks(resources, config, assignments))
