...
PACKAGES = {
    ...
    'hl7.fhir.uv.extensions.r4': ('5.2.0', 'https://packages.fhir.org/hl7.fhir.uv.extensions.r4/5.2.0'),
}
...
def fetch(item):
    ...
    return {'id': name, 'version': version, 'url': url,
...
if __name__ == '__main__':
    ...
    lock = {'schema_version': 1, 'reviewed': '2026-09-17', 'fhir': '4.0.1',
            'receiver_compatibility': 'unconfirmed', 'packages': packages,
